...
for j in range(1, 6):
    ...
    ensemble_clf = VotingClassifier(estimators=[
                                ...
                                ('XGB', XGBClassifier(n_estimators=200, max_depth=20, learning_rate=0.01)),
                                ('lgbm', LGBMClassifier(n_estimators=200, learning_rate=0.1, max_depth=3)),
                                ('bag', BaggingClassifier(n_estimators=200))
                            ], voting='hard',verbose=False)
    ensemble_clf.fit(X_train_scaled, y_train)
    predicted = ensemble_clf.predict(X_val_scaled)
    cm = confusion_matrix(y_val, predicted)
    print('Accuracy: %f' % accuracy_score(y_val, predicted))
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting w/o SMOTE")
    ...
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting w/ SMOTE")

    ensemble_clf = VotingClassifier(estimators=[
                                ('svm', svm.SVC()),
                                ('rf', RandomForestClassifier(n_estimators=50, max_depth=20)),
                                ('knn', KNeighborsClassifier(n_neighbors=3)),
                                ('XGB', XGBClassifier(n_estimators=50, max_depth=20, learning_rate=0.01)),
                                ('lgbm', LGBMClassifier(n_estimators=50, learning_rate=0.1, max_depth=3)),
                                ('bag', BaggingClassifier(n_estimators=50))
                            ], voting='hard',verbose=False)
    ensemble_clf.fit(X_train_pca, y_train)
    predicted = ensemble_clf.predict(X_val_pca)
    cm = confusion_matrix(y_val, predicted)
    print('Accuracy: %f' % accuracy_score(y_val, predicted))
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting PCA w/o SMOTE")
    ...
    ensemble_clf.fit(X_train_pca_smote, y_train_pca_smote)
    predicted = ensemble_clf.predict(X_val_pca)
    cm = confusion_matrix(y_val, predicted)
    print('Accuracy: %f' % accuracy_score(y_val, predicted))
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting PCA w/ SMOTE")
    ...
    ensemble_clf.fit(X_train_lda, y_train)
    predicted = ensemble_clf.predict(X_val_lda)
    cm = confusion_matrix(y_val, predicted)
    print('Accuracy: %f' % accuracy_score(y_val, predicted))
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting LDA w/o SMOTE")
    ...
    ensemble_clf.fit(X_train_lda_smote, y_train_lda_smote)
    predicted = ensemble_clf.predict(X_val_lda)
    cm = confusion_matrix(y_val, predicted)
    print('Accuracy: %f' % accuracy_score(y_val, predicted))
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting LDA w/ SMOTE")
    ...
    ensemble_clf.fit(X_train_dt, y_train)
    predicted = ensemble_clf.predict(X_val_dt)
    cm = confusion_matrix(y_val, predicted)
    print('Accuracy: %f' % accuracy_score(y_val, predicted))
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting DT w/o SMOTE")
    ...
    ensemble_clf.fit(X_train_dt_smote, y_train_dt_smote)
    predicted = ensemble_clf.predict(X_val_dt)
    cm = confusion_matrix(y_val, predicted)
    print('Accuracy: %f' % accuracy_score(y_val, predicted))
    print(cm)
    icbhi_score(cm)
    draw_cm(np.array(cm), "Voting DT w/ SMOTE")